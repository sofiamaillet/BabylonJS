...
export class StandardMaterials {
  ...
  CreateGroundMaterial(): StandardMaterial {
    ...
    const diffuseTex = new Texture(
      "./textures/cobblestone/cobblestone_diffuse.jpg", 
      this.scene
    );
    ...
    const normalTex = new Texture(
      "./textures/cobblestone/cobblestone_normal.jpg", 
      this.scene
    );
    ...
    const aoTex = new Texture(
      "./textures/cobblestone/cobblestone_ao.jpg", 
      this.scene
    );
    ...
    const specTex = new Texture(
      "./textures/cobblestone/cobblestone_spec.jpg", 
      this.scene
    );
